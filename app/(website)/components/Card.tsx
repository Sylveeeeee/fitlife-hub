...
export default function Card() {
  return (
    <div className="flex justify-center px-4">
      <div className="text-center m-5 p-6 w-[400px] max-w-sm md:max-w-md lg:max-w-lg bg-gradient-to-r from-blue-500 to-green-400 rounded-xl h-auto min-h-[250px] shadow-xl flex flex-col items-center text-white">
