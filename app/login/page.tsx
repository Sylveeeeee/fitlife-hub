export default function LoginPage () {
    return (
      <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#d5d5d5]">
  <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden">
    <div className="flex-1 flex items-center justify-center p-8 bg-[#213A58] text-white">
      <div className="text-center">
        ...
        <h2 className="text-lg">FreeCourse</h2>
        <img aria-hidden="true" alt="illustration" src="https://openui.fly.dev/openui/300x300.svg?text=Illustration" />
      </div>
    </div>
